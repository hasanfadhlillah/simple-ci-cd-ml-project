...
model_dir = 'model'
print(f"4. Membuat direktori '{model_dir}' jika belum ada...")
os.makedirs(model_dir, exist_ok=True)
print("   Direktori berhasil dibuat.")
print(" ")

# Menyimpan model
model_filename = os.path.join(model_dir, 'simple_linear_regression.joblib')
print(f"5. Menyimpan model ke file '{model_filename}'...")
